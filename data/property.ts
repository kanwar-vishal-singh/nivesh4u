...
export const propertyData: Property[] = [
  {
    ...
    description:
      "Premium commercial space featuring state-of-the-art facilities, modern architecture, and strategic location. Perfect for businesses looking for a prestigious address in Mumbai's prime commercial district.",
    type: "commercial",
    price: 25000000,
    location: {
    ...
    amenities: [
      ...
      {
        name: "Parking",
        description: "Reserved parking spaces with valet service",
        icon: "car",
      },
      {
  ...
  },
  {
    ...
    description:
      "Elegant 3BHK apartment with premium finishes, sea view, and world-class amenities. Located in one of Mumbai's most prestigious neighborhoods.",
    type: "residential",
    price: 45000000,
    location: {
  ...
  },
  {
    ...
    description:
      "Fertile agricultural land with excellent water resources and road connectivity. Perfect for agricultural ventures and farming projects.",
    type: "agricultural",
    price: 7500000,
    location: {
    ...
    amenities: [
      {
        name: "Water Supply",
        description: "Year-round water availability",
        icon: "droplet",
      },
      {
        name: "Road Access",
        description: "Direct highway connectivity",
        icon: "road",
      },
      {
        name: "Power Supply",
        description: "3-phase electricity connection",
        icon: "zap",
      },
      {
        name: "Storage",
        description: "Built-in storage facility",
        icon: "warehouse",
      },
    ],
    images: [
  ...
  },
  {
    ...
    description:
      "Strategic industrial plot with excellent infrastructure and connectivity. Ideal for manufacturing units and warehouses.",
    type: "industrial",
    price: 18000000,
    location: {
      ...
      nearbyPlaces: [
        ...
        {
          name: "container max-w-screen-xl Depot",
          distance: "5 km",
          type: "logistics",
        },
    ...
    amenities: [
      {
        name: "Power Supply",
        description: "Industrial power connection",
        icon: "zap",
      },
      {
      ...
      {
        name: "Security",
        description: "24x7 industrial park security",
        icon: "shield",
      },
      {
        name: "Loading Bay",
        description: "Built-in loading/unloading bay",
        icon: "truck",
      },
    ],
    images: [
  ...
  },
  {
    ...
    description:
      "Modern office space in Mumbai's premier business district with world-class amenities and excellent connectivity.",
    type: "commercial",
    price: 35000000,
    location: {
    ...
    amenities: [
      {
        name: "24/7 Access",
        description: "Round-the-clock building access",
        icon: "clock",
      },
      {
  ...
  },
  {
    ...
    description:
      "Luxurious 4BHK villa with private pool, garden, and panoramic valley views. Perfect for a weekend getaway or permanent residence.",
    type: "residential",
    price: 55000000,
    location: {
    ...
    amenities: [
      ...
      {
        name: "Smart Home",
        description: "Automated home systems",
        icon: "smartphone",
      },
      {
        name: "Security",
        description: "Gated community security",
        icon: "shield",
      },
    ],
    images: [
    ...
    features: ["Valley View", "Private Pool", "Smart Home", "Luxury Finishes"],
    yearBuilt: 2023,
    status: "available",
  },
];
